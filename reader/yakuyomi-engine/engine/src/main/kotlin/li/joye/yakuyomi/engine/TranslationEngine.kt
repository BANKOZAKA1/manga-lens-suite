...
interface TranslationEngine : AutoCloseable {
    ...
    /**
     * Versioned suite contract. Existing engines keep their optimized bitmap path;
     * request metadata is consumed by Adaptive/LAN adapters before this fallback.
     */
    suspend fun translatePage(request: PageRequest): PageResult = translatePage(request.image)
