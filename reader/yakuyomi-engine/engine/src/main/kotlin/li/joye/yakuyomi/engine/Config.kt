...
data class TranslatorConfig(
    val provider: String = "custom",                                    // 〔設定〕config.translator
    val targetLang: String = "THA",                                     // 〔設定〕config.target_lang
    ...
    val model: String = "translategemma:4b",                             // 〔設定〕
    val apiBase: String = "http://192.168.1.8:8765/v1/chat/completions", // 〔設定〕custom_openai 用
    ...
    val toLangName: String = "Thai (natural dialogue used in Thai manga translations)", // 〔設定〕目標語言
    val fromLangName: String = "",                  // 〔設定〕來源語言標註（空白＝讓 LLM 自己判）
    val sampleSource: String = "",                  // 〔設定〕few-shot 原文（空白＝ไม่ใส่ตัวอย่างข้ามภาษา）
    val sampleTarget: String = "",                  // 〔設定〕few-shot 譯文
