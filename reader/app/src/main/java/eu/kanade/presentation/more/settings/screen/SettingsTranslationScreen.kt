...
object SettingsTranslationScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        val targetLangs = persistentMapOf(
            TranslationPreferences.DEFAULT_TARGET_LANG to stringResource(MR.strings.pref_translation_lang_thai),
            "Traditional Chinese (Taiwan, 台灣慣用的繁體中文用語)" to stringResource(MR.strings.pref_translation_lang_trad_chinese),
