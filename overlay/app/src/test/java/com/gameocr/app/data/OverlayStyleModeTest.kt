...
class OverlayStyleModeTest {
    ...
    @Test
    fun defaults_useAdaptiveMangaLayout() {
        assertEquals(OverlayStyleMode.ADAPTIVE, Settings().overlayStyleMode)
        assertEquals(OverlayStyleMode.ADAPTIVE, TranslationPreset(id = "id", name = "name").overlayStyleMode)
    }
